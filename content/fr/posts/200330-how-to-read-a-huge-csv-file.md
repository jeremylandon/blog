...
- des guillemets dans des guillemets pour représenter des guillemets dans une colonnes…
- …
...
Bien entendu d'autres se sont pris la tête là-dessus, c'est pour cette raison qu'il existe un grand nombre de framework de lecture/écriture de fichier csv qui gère la totalité des problématique liées à ce format.
